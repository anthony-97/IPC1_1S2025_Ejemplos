    ...
    private void procesarColaServicio() {
        while (!terminado) {
            ...
            if (!this.modelo.getColaServicio().isEmpty()) {
                ...
                for (Mecanico m : this.modelo.getListaMecanicos()) {
                    System.out.println("El mecanico " + orden.getMecanico() + " se desocupo");
                ...
                //Se intenta pasar de espera a servicio ya que se desocupo un mecanico
                this.intentarDarServicio();  
